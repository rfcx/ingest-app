...
<style lang="scss">
  ...
  .mapboxgl-map {
    &:after {
      ...
      background: -moz-linear-gradient(90deg, rgba(19,21,37,0) 0%, rgba(19,21,37,0.9) 85%, rgba(19,21,37,1) 100%);
      background: -webkit-linear-gradient(90deg, rgba(19,21,37,0) 0%, rgba(19,21,37,0.9) 85%, rgba(19,21,37,1) 100%);
      background: linear-gradient(90deg, rgba(19,21,37,0) 0%, rgba(19,21,37,0.9) 85%, rgba(19,21,37,1) 100%);

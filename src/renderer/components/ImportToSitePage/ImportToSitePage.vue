...
export default {
  ...
  computed: {
    ...
    hasPassedValidation () {
      return this.form.selectedSiteName && ((this.isCreatingNewSite && this.selectedCoordinates && this.selectedCoordinates.length > 1) || !this.isCreatingNewSite) && this.hasPassProjectValidation
    },
    selectedCoordinates () {
